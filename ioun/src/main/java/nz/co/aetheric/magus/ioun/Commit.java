 ...
 *         &lt;element name="targetID" type="{http://schemas.datacontract.org/2004/07/WotC.ContentVault}ContentIdentifier" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Commit {
    ...
    @XmlElementRef(name = "targetID", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ContentIdentifier> targetID;
     ...
     *     
     */
    public JAXBElement<ContentIdentifier> getTargetID() {
        return targetID;
    }
     ...
     *     
     */
    public void setTargetID(JAXBElement<ContentIdentifier> value) {
        this.targetID = value;
    }
